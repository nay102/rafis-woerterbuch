...
const previous=Math.max(1,module.number-1),next=Math.min(10,module.number+1);$("previousModule").href=`./?level=${module.level}&module=${previous}`;$("nextModule").href=`./?level=${module.level}&module=${next}`;$("previousModule").classList.toggle("disabled",module.number===1);$("nextModule").classList.toggle("disabled",module.number===10);
